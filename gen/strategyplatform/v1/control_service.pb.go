...
type AuditEntry struct {
	...
	Action      string                 `protobuf:"bytes,3,opt,name=action,proto3" json:"action,omitempty"` // "Deploy" | "SetDeployment" | "Rollback" | "ConfigChange" | "Stop" | "Start" | "Undeploy" | "DownloadFiles" | "CreateToken" | "RevokeToken" | "RegisterArtifact" | "SetSharedFiles" | "ResolveArtifactSource"
...
const file_strategyplatform_v1_control_service_proto_rawDesc = "" +
	"\n" +
	")strategyplatform/v1/control_service.proto\x12\x13strategyplatform.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a'strategyplatform/v1/agent_service.proto\x1a strategyplatform/v1/common.proto\x1a$strategyplatform/v1/enrollment.proto\x1a strategyplatform/v1/status.proto\x1a#strategyplatform/v1/telemetry.proto\"\x8f\x04\n" +
	"\aMachine\x12;\n" +
	...
	"\x0elast_processes\x18\t \x03(\v2#.strategyplatform.v1.ProcessMetricsR\rlastProcesses\"\xab\b\n" +
	...
	"deployedAt\x12\x18\n" +
	"\astopped\x18\x16 \x01(\bR\astopped\"Q\n" +
	...
	"\n" +
	"to_version\x18\a \x01(\tR\ttoVersion\x12\x16\n" +
	"\x06detail\x18\b \x01(\tR\x06detail\"a\n" +
	"\x10BrowseDirRequest\x12\x1d\n" +
	"\n" +
	"machine_id\x18\x01 \x01(\tR\tmachineId\x12\x1a\n" +
	"\bstrategy\x18\x02 \x01(\tR\bstrategy\x12\x12\n" +
	"\x04path\x18\x03 \x01(\tR\x04path\"`\n" +
	"\x11BrowseDirResponse\x127\n" +
	"\aentries\x18\x01 \x03(\v2\x1d.strategyplatform.v1.DirEntryR\aentries\x12\x12\n" +
	"\x04path\x18\x02 \x01(\tR\x04path\"g\n" +
	"\x14DownloadFilesRequest\x12\x1d\n" +
	"\n" +
	"machine_id\x18\x01 \x01(\tR\tmachineId\x12\x1a\n" +
	"\bstrategy\x18\x02 \x01(\tR\bstrategy\x12\x14\n" +
	"\x05paths\x18\x03 \x03(\tR\x05paths\"\x99\x01\n" +
	"\rDownloadChunk\x12\x12\n" +
	"\x04data\x18\x01 \x01(\fR\x04data\x12\x1a\n" +
	"\bfilename\x18\x02 \x01(\tR\bfilename\x12F\n" +
	"\rtransfer_kind\x18\x03 \x01(\x0e2!.strategyplatform.v1.TransferKindR\ftransferKind\x12\x10\n" +
	"\x03eof\x18\x04 \x01(\bR\x03eof\"\x89\x01\n" +
	...
	"\asamples\x18\x01 \x03(\v2(.strategyplatform.v1.ResourceSamplePointR\asamples\"p\n" +
	"\x15SetSharedFilesRequest\x12\x1d\n" +
	"\n" +
	"machine_id\x18\x01 \x01(\tR\tmachineId\x128\n" +
	"\x05files\x18\x02 \x03(\v2\".strategyplatform.v1.SharedFileRefR\x05files\"s\n" +
	"\rSharedFileRef\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12)\n" +
	"\x10artifact_version\x18\x02 \x01(\tR\x0fartifactVersion\x12#\n" +
	"\rartifact_name\x18\x03 \x01(\tR\fartifactName\"8\n" +
	"\x16SetSharedFilesResponse\x12\x1e\n" +
	"\n" +
	"generation\x18\x01 \x01(\x03R\n" +
	"generation\"7\n" +
	"\x16ListSharedFilesRequest\x12\x1d\n" +
	"\n" +
	"machine_id\x18\x01 \x01(\tR\tmachineId\"T\n" +
	"\x17ListSharedFilesResponse\x129\n" +
	"\x05files\x18\x01 \x03(\v2#.strategyplatform.v1.SharedFileViewR\x05files\"\xd8\x01\n" +
	"\x0eSharedFileView\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12'\n" +
	"\x0fdesired_version\x18\x02 \x01(\tR\x0edesiredVersion\x12%\n" +
	"\x0edesired_digest\x18\x03 \x01(\tR\rdesiredDigest\x12%\n" +
	"\x0erunning_digest\x18\x04 \x01(\tR\rrunningDigest\x12\x1c\n" +
	"\tconverged\x18\x05 \x01(\bR\tconverged\x12\x1d\n" +
	"\n" +
	"last_error\x18\x06 \x01(\tR\tlastError2\xd5\x0e\n" +
	...
	"\bRollback\x12$.strategyplatform.v1.RollbackRequest\x1a%.strategyplatform.v1.RollbackResponse\x12K\n" +
	"\x04Stop\x12 .strategyplatform.v1.StopRequest\x1a!.strategyplatform.v1.StopResponse\x12N\n" +
	"\x05Start\x12!.strategyplatform.v1.StartRequest\x1a\".strategyplatform.v1.StartResponse\x12W\n" +
	"\bUndeploy\x12$.strategyplatform.v1.UndeployRequest\x1a%.strategyplatform.v1.UndeployResponse\x12`\n" +
	"\vSetSchedule\x12'.strategyplatform.v1.SetScheduleRequest\x1a(.strategyplatform.v1.SetScheduleResponse\x12i\n" +
	"\x0eSetSharedFiles\x12*.strategyplatform.v1.SetSharedFilesRequest\x1a+.strategyplatform.v1.SetSharedFilesResponse\x12l\n" +
	"\x0fListSharedFiles\x12+.strategyplatform.v1.ListSharedFilesRequest\x1a,.strategyplatform.v1.ListSharedFilesResponse\x12a\n" +
	...
	"\x11GetMachineMetrics\x12-.strategyplatform.v1.GetMachineMetricsRequest\x1a..strategyplatform.v1.GetMachineMetricsResponse\x12Z\n" +
	"\tBrowseDir\x12%.strategyplatform.v1.BrowseDirRequest\x1a&.strategyplatform.v1.BrowseDirResponse\x12`\n" +
	"\rDownloadFiles\x12).strategyplatform.v1.DownloadFilesRequest\x1a\".strategyplatform.v1.DownloadChunk0\x01BMZKgithub.com/bullionbear/strategon/gen/strategyplatform/v1;strategyplatformv1b\x06proto3"
