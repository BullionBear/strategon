...
export type SharedFileRef = Message<"strategyplatform.v1.SharedFileRef"> & {
  /**
   * basename on disk, e.g. "instruments.json"
   *
   * @generated from field: string name = 1;
   */
  name: string;
  ...
  /**
   * references registered artifact (name, version)
   *
